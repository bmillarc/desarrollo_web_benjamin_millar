...
def validate_comment_data(data):
    ...
    if not nombre:
        errors.append("El nombre del comentarista es requerido.")
    elif len(nombre) < 3 or len(nombre) > 80:
        errors.append("El nombre debe tener entre 3 y 80 caracteres.")
        
    if not texto:
        errors.append("El texto del comentario es requerido.")
    elif len(texto) < 5:
        errors.append("El texto del comentario debe tener al menos 5 caracteres.")
